...
function tryCargoInstall() {
  ...
  try {
    execSync("cargo install --git https://github.com/ulises-c/railguard.git", {
      stdio: "inherit",
    });
...
async function main() {
  ...
  console.error("    cargo install --git https://github.com/ulises-c/railguard.git");
  console.error();
  process.exit(1);
}
